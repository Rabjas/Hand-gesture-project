...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/028HT9eM8/model.json",modelLoaded);
function modelLoaded(){
    console.log('ModelLoaded!');
}
function speak(){
    var synth=window.speechSynthesis;
    speak_data_1="The First Prediction Is"+ prediction_1+" And The Second Prediction Is "+prediction_2;
